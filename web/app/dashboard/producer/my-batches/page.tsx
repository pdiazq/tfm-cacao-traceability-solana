...
export default function ProducerMyBatchesPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Loading your batches...</p>
        </div>
      </div>
    );
  }
    ...
    <div>
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2">My Cacao Batches</h1>
          <p className="text-gray-300 font-medium">
            Review all batches created from your farm or production origin.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
          <div>
            <h2 className="text-3xl font-black text-black">Created Batches</h2>
            <p className="text-gray-600 font-medium mt-1">
              You have {batches.length} batch{batches.length === 1 ? "" : "es"} registered on-chain.
            </p>
          </div>
        ...
        {batches.length === 0 ? (
          <div className="bg-white border-4 border-black rounded-lg p-12 text-center">
            <div className="text-6xl mb-4">🍫</div>
            <h3 className="text-2xl font-black text-black mb-3">No batches yet</h3>
            <p className="text-gray-600 font-medium mb-6">
              Create your first cacao batch to begin blockchain traceability.
            </p>
            <button
              onClick={() => router.push("/dashboard/producer/create-batch")}
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-black">{batch.dateCreated}</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="bg-gray-50 border-2 border-black rounded-lg p-3">
                      ...
                      <p className="text-xl font-black text-black">{batch.eventCount}</p>
                    </div>

                    <div className="bg-gray-50 border-2 border-black rounded-lg p-3">
                      <p className="text-xs text-gray-500 font-semibold">Certificates</p>
                      <p className="text-xl font-black text-black">{batch.certificateCount}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex gap-3 flex-wrap">
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-gray-200 hover:bg-gray-300 text-black font-bold rounded-lg transition"
                  >
                    Copy ID
                  </button>
                </div>
