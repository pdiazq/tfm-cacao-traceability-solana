...
export default function RecordTransportPage() {
  ...
  const [metadata, setMetadata] = useState(
    '{"vehicle":"Truck-27","temperature":"24C","notes":"Batch moved to storage hub"}'
  );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to record transport"
      );
    } finally {
    ...
    <div>
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2">Record Transport</h1>
          <p className="text-gray-300 font-medium">
            Register a transport event for a cacao batch in the logistics stage.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Ruta Pasto-Buenaventura"
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              placeholder='{"vehicle":"Truck-27","temperature":"24C","notes":"Batch moved to storage hub"}'
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
              required
            />
            <p className="text-xs text-gray-600 font-semibold mt-2">
              Suggested fields: vehicle, driver, temperature, humidity, route,
              notes.
            </p>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {isSubmitting ? "⏳ Recording..." : "✓ Record Transport"}
            </button>
