...
export default function TransporterMyBatchesPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600">Loading logistics batches...</p>
        </div>
      </div>
    );
  }
  ...
  const logisticsBatches = batches.filter(
    (batch) =>
      batch.status === "dried" ||
    ...
    <div>
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2">Logistics Batches</h1>
          <p className="text-gray-300 font-medium">
            Review cacao batches in transport and storage stages.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        <div className="flex items-center justify-between mb-8 gap-4 flex-wrap">
          <div>
            <h2 className="text-3xl font-black text-black">Transporter View</h2>
            <p className="text-gray-600 font-medium mt-1">
              {logisticsBatches.length} batch
              {logisticsBatches.length === 1 ? "" : "es"} available in the logistics workflow.
            </p>
          </div>
        ...
        {logisticsBatches.length === 0 ? (
          <div className="bg-white border-4 border-black rounded-lg p-12 text-center">
            ...
            <h3 className="text-2xl font-black text-black mb-3">
              No logistics batches yet
            </h3>
            <p className="text-gray-600 font-medium mb-6">
              You will see dried, in-transit, or stored cacao batches here.
            </p>
            <button
              onClick={refetch}
            ...
            {logisticsBatches.map((batch) => (
              ...
              >
                ...
                <div className="mt-6 flex gap-3 flex-wrap">
                  ...
                  <button
                    onClick={() =>
                      router.push("/dashboard/transporter/update-status")
                    }
                    className="flex-1 min-w-[140px] px-4 py-3 bg-gray-200 hover:bg-gray-300 text-black font-bold rounded-lg transition"
                  >
                    Update Status
