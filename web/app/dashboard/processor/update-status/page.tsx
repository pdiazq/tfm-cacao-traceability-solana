...
type ProcessorStatus = "fermented" | "dried";

export default function ProcessorUpdateStatusPage() {
  ...
  const [newStatus, setNewStatus] = useState<ProcessorStatus>("fermented");
      ...
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-300 font-medium">
            Move a cacao batch through the processor stage of the lifecycle.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            <select
              id="newStatus"
              value={newStatus}
              onChange={(e) => setNewStatus(e.target.value as ProcessorStatus)}
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
            >
            ...
            <p className="text-xs text-gray-600 font-semibold mt-2">
              Use fermented after fermentation, and dried after drying.
            </p>
          </div>
