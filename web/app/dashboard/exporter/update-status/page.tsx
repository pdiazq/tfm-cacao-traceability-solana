...
type ExporterStatus = "exported";

export default function ExporterUpdateStatusPage() {
  ...
  const [newStatus, setNewStatus] = useState<ExporterStatus>("exported");
    ...
    <div>
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2">Update Export Status</h1>
          <p className="text-gray-300 font-medium">
            Move a certified cacao batch into the exported state.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            <select
              id="newStatus"
              value={newStatus}
              onChange={(e) => setNewStatus(e.target.value as ExporterStatus)}
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
            >
              <option value="exported">exported</option>
            </select>
            <p className="text-xs text-gray-600 font-semibold mt-2">
              The exporter can move the batch from certified to exported.
            </p>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {isSubmitting ? "⏳ Updating..." : "✓ Mark as Exported"}
            </button>
