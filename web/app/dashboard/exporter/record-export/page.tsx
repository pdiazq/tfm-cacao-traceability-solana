...
export default function RecordExportPage() {
  ...
  const [metadata, setMetadata] = useState(
    '{"destination":"Puerto de Cartagena","container":"CONT-4582","notes":"Batch prepared for export"}'
  );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to record export"
      );
    } finally {
    ...
    <div>
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-2">Record Export</h1>
          <p className="text-gray-300 font-medium">
            Register an export event for a certified cacao batch.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Puerto de Cartagena, Colombia"
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              placeholder='{"destination":"Puerto de Cartagena","container":"CONT-4582","notes":"Batch prepared for export"}'
              className="w-full px-4 py-3 text-black bg-gray-50 border-4 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:bg-white"
              required
            />
            <p className="text-xs text-gray-600 font-semibold mt-2">
              Suggested fields: destination, container, export_doc, ship_date,
              notes.
            </p>
          </div>
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {isSubmitting ? "⏳ Recording..." : "✓ Record Export"}
            </button>
