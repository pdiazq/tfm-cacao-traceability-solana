      ...
      <div className="bg-black text-white py-12 px-4 border-b-4 border-black mb-12">
        <div className="max-w-7xl mx-auto">
          <div>
            ...
            <h1 className="text-4xl font-black mb-2">My Products</h1>
            <p className="text-gray-300 font-medium">
              Verified products with complete supply chain traceability
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        ...
        {isLoading ? (
          ...
          <div className="bg-white border-4 border-black rounded-lg p-16 text-center">
            ...
            <h3 className="text-3xl font-black text-black mb-3">No Products Received</h3>
            <p className="text-gray-700 font-medium mb-8 max-w-md mx-auto">
              You haven't received any products yet. Once retailers share products with you, you'll be able to verify their authenticity here.
            </p>
            <button
              onClick={() => router.push("/dashboard/consumer/transfers")}
          ...
          <div>
            <div className="mb-8">
              <p className="text-lg font-semibold text-gray-600">
                You have verified <span className="font-black text-black text-2xl">{tokensInfo.length}</span> product{tokensInfo.length !== 1 ? 's' : ''}
              </p>
            </div>
