        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h1 className="text-4xl font-black mb-2">My Tokens</h1>
              <p className="text-gray-300 font-medium">
                Manage all your created product tokens
              </p>
            </div>
            <button
            ...
            >
              <span className="text-2xl">+</span> Create Token
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="text-lg text-gray-600">Loading your tokens...</p>
          </div>
        ) : tokensInfo.length === 0 ? (
          <div className="bg-white border-4 border-black rounded-lg p-16 text-center">
            ...
            <p className="text-gray-700 font-medium mb-8 max-w-md mx-auto">
              You haven't created any product tokens yet. Start by creating your first token and begin your supply chain journey.
            </p>
            <button
              onClick={() => router.push("/dashboard/producer/create-token")}
          ...
          <div>
            <div className="mb-8">
              <p className="text-lg font-semibold text-gray-600">
                You have <span className="font-black text-black text-2xl">{tokensInfo.length}</span> token{tokensInfo.length !== 1 ? 's' : ''} created
              </p>
            </div>
